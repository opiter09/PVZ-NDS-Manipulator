...
Also, you cannot change file sizes. Larger files are truncated, while smaller files get a bunch of 0x00's added to the end. If this becomes a problem, do let me know.
